import { Mail, MapPin, Phone, Clock, Heart, Sparkles, ArrowUpRight } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 justify-between">
            ...
            <motion.div
              ...
              className="bg-slate-50/60 dark:bg-slate-900/60 rounded-3xl border border-slate-100 dark:border-slate-800 p-6 sm:p-8 flex items-start gap-5 hover:border-brand-blue/15 hover:shadow-xl hover:shadow-slate-100/35 dark:hover:shadow-black/40 transition-all duration-300"
            >
              ...
              <div className="space-y-3 flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] font-mono uppercase tracking-wider bg-slate-200/50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-2.5 py-1 rounded-full font-bold">
                    HQ Ghana
                  </span>
                </div>
                <div className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed font-bold break-words">
                  {location}
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="inline-flex items-center gap-1.5 text-xs text-brand-blue bg-brand-blue/5 dark:bg-brand-blue/10 border border-brand-blue/10 px-3 py-1 rounded-lg font-semibold">
