...
export const contactSettingsConverter: FirestoreDataConverter<ContactSettings> = {
  toFirestore(settings: ContactSettings): DocumentData {
    return {
      ...
      metricNumber: settings.metricNumber || '50+',
      metricSubtitle: settings.metricSubtitle || 'Delivered Projects',
      metricDescription: settings.metricDescription || 'Precision-engineered branding, flyers, and digital platforms.',
      ...
      heroDescription: settings.heroDescription || 'We custom-engineer premium visual branding, high-speed digital platforms, and high-converting marketing flyers crafted to position your enterprise ahead of the competition.',
      ...
      heroCardText: settings.heroCardText || 'Complete visual identity frameworks, logo systems, and comprehensive brand guidelines engineered to build deep trust.',
